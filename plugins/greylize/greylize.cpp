...
GreylizePane::GreylizePane(wxWindow *parent, Plugin *plug, wxWindowID id)
    :GreylizePaneBase(parent, id), PluginHelper(plug)
{

}

void GreylizePane::OnApply(wxCommandEvent &event)
{
    ...
    wxString caption = GetCurrentPageText() + "[grey]";
    AddImage(image, caption);
}

void GreylizePane::OnRedScroll(wxScrollEvent &event)
{
...
void GreylizePane::OnGreenScroll(wxScrollEvent &event)
{
    int red, green, blue, max_value;
    GetSliderValue(red, green, blue, max_value);
...
void GreylizePane::OnBlueScroll(wxScrollEvent &event)
{
    int red, green, blue, max_value;
    GetSliderValue(red, green, blue, max_value);
